...
[[nodiscard]] std::string ANSI::COLOR::basic_color_code( ANSI::COLOR::BASIC color )
{
    switch (color)
    {
        COLOR_CASE(BLACK);
...
[[nodiscard]] std::string ANSI::COLOR::build_color_code( ANSI::COLOR_BYTE red, ANSI::COLOR_BYTE green, ANSI::COLOR_BYTE blue )
...
{ return ANSI::COLOR::get_base(level) + ANSI::COLOR::basic_color_code(color) + CODE::CONTROL::END; }

[[nodiscard]] ANSI::COLOR ANSI::build_color( ANSI::COLOR_BYTE red, ANSI::COLOR_BYTE green, ANSI::COLOR_BYTE blue, LAYER level )
{ return ANSI::COLOR::get_base(level) + ANSI::COLOR::build_color_code(red, green, blue) + CODE::CONTROL::END; }